package com.rabbitmq.task.parser;
...
import com.rabbitmq.task.annotaion.ElasticJobConfig;
import com.rabbitmq.task.annotaion.ListenerConfiguration;
import com.rabbitmq.task.autoconfigure.ElasticJobZookeeperProperties;
...
public class ElasticJobConfigParser implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent applicationReadyEvent) {
        ...
        try {
            ...
            for (Iterator<?> iterator = beansWithAnnotation.values().iterator(); iterator.hasNext(); ) {
                 ...
                 * 一级配置
                 */
                com.rabbitmq.task.annotaion.JobCoreConfiguration jobCoreConfiguration = annotation.coreConfig();
                 ...
                 * 三级配置
                 */
                com.rabbitmq.task.annotaion.LiteJobConfiguration liteJobConfiguration = annotation.liteJobConfig();
    ...
    private JobCoreConfiguration getJobCoreConfiguration(com.rabbitmq.task.annotaion.JobCoreConfiguration jobCoreConfiguration){
    ...
    private LiteJobConfiguration getLiteJobConfiguration(com.rabbitmq.task.annotaion.LiteJobConfiguration liteJobConfiguration
    ...
    private List<BeanDefinition> getTargetElasticJobListeners(com.rabbitmq.task.annotaion.ListenerConfiguration listenerConfiguration) {
